...
-- employees 테이블의 부서id 와 일치하는 departments 테이블의 부서 id 를
...
3. 위의 조인한 결과와 동일한 department_id 를 가진 employees 테이블의 데이터를 찾아 조인
...
어느 한 테이블에 공통 값이 없더라도 해당 row 들이 조회 결과에
모두 포함되는 조인을 말합니다.
*/
