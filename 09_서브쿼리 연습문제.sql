...
/*
문제 2.
-DEPARTMENTS테이블에서 manager_id가 100인 부서에 속해있는 사들람의 
모든 정보를 출력하세요.
*/
SELECT *
FROM employees e
...
*/
SELECT loc.location_id,loc.street_address,loc.city,loc.country_id,
       cou.country_name
FROM locations loc
